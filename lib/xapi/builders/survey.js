...
module.exports = function buildSurvey(ctx, payload) {
  try {
    ...
    // v1.0: survey 영역은 survey/1.0/verbs/submitted IRI 단일 (responded/submitted 입력 모두)
    const verb = VERB.surveySubmitted;
    ...
    // makeContext 가 school-info 를 자동 주입하므로, 표준체계가 비어도 안전.
